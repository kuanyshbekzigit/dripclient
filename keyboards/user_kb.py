...
def main_inline_keyboard(lang: str = "en") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text=get_text(lang, "btn_profile"), callback_data="menu_profile", **{"style": "primary"}),
                InlineKeyboardButton(text=get_text(lang, "btn_links"), callback_data="menu_links", **{"style": "primary"})
            ]
        ]
    )

def back_to_main_keyboard(lang: str = "en", text: str = "⬅️ Back") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
...
def products_keyboard(products, is_vip: bool = False, lang: str = "kk") -> InlineKeyboardMarkup:
    ...
    rows.append([InlineKeyboardButton(text="⬅️ Back", callback_data="back_to_main", **{"style": "danger"})])
